...
def update_node_at_pos(head: None | Node, position: int, data: int) -> None | Node:
...
my_llist.head = update_node_at_pos(my_llist.head, 3, 3)
my_llist.print_list()

my_llist.head = update_node_at_pos(my_llist.head, 0, 0)
my_llist.print_list()

my_llist.head = update_node_at_pos(my_llist.head, 1, 1)
my_llist.print_list()

# testing: position = -100 (underflow)
my_llist.head = update_node_at_pos(my_llist.head, -100, -100)
my_llist.print_list()
...
# AFTER MANIPULATIONS
# The Linked List -> 10-> 20-> 30-> 3-> 50
# The Linked List -> 0-> 20-> 30-> 3-> 50
# The Linked List -> 0-> 1-> 30-> 3-> 50
# The Linked List -> 0-> 1-> 30-> 3-> 50
# The Linked List -> 0-> 1-> 30-> 3-> 50
